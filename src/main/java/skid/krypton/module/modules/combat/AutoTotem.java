...
public final class AutoTotem extends Module {
    ...
    public void onTick(final StartTickEvent event) {
        ...
        final Module rtpBaseFinder = Krypton.INSTANCE.MODULE_MANAGER.getModuleByClass(RtpBaseFinder.class);
        if (rtpBaseFinder.isEnabled() && ((RtpBaseFinder) rtpBaseFinder).isRepairingActive()) {
            return;
        }
        final Module tunnelBaseFinder = Krypton.INSTANCE.MODULE_MANAGER.getModuleByClass(TunnelBaseFinder.class);
